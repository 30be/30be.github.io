...
The site compiler is based on the Haskell static site framework, Hakyll. It is just a couple of hundred lines of code, all in [one file](https://github.com/30be/30be.github.io/blob/main/main.hs).
